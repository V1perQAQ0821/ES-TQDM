...
import sys
sys.path.append('/root/autodl-tmp/tqdm-main/models/segmentors')
from mmseg.ops import resize
from mmseg.core import add_prefix
from mmseg.models import builder
from mmseg.models.builder import SEGMENTORS
from mmseg.models.segmentors.base import BaseSegmentor
from EMA_attention_module import *
...
class tqdm_EVA_CLIP(BaseSegmentor):
    ...
    def __init__(self,
        ...
        #new EMA
        self.ema = EMA(channels=768, factor=32)
        #simam
    ...
    def after_extract_feat(self, x):
        ...
        visual_embeddings = self.ema(visual_embeddings)
        visual_embeddings = self.simam(visual_embeddings)
